...
{
    public override string Name => MiraLocaleManager.Get("TouRoleDoomsayerObserve", "Observe");
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            MiraLocaleManager.Get("TouRoleDoomsayerObserveNotif").Replace("<player>", $"{TownOfUsColors.Doomsayer.ToTextColor()}{Target.Data.PlayerName}</color>"),
