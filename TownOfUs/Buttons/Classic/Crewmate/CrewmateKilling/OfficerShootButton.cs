...
{
    public override string Name => MiraLocaleManager.Get("TouRoleOfficerShoot", "Shoot");
    ...
    private void Misfire()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification($"<b>{MiraLocaleManager.Get("TouRoleOfficerBadKillFeedback")}</b>",
