...
{
    public override string Name => MiraLocaleManager.Get("TouRoleVeteranAlert", "Alert");
    ...
    protected override void OnClick()
    {
        ...
        OverrideName(MiraLocaleManager.Get("TouRoleVeteranAlerting", "Alerting"));
    }

    public override void OnEffectEnd()
    {
        OverrideName(MiraLocaleManager.Get("TouRoleVeteranAlert", "Alert"));
    }
}