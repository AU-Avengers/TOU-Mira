...
{
    public override string Name => MiraLocaleManager.Get("TouRoleHunterStalk", "Stalk");
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            $"<b>{MiraLocaleManager.Get("TouRoleHunterStalkNotif").Replace("<player>", Target.Data.PlayerName)}</b>",
        ...
        OverrideName(MiraLocaleManager.Get("TouRoleHunterStalking", "Stalking"));
    }

    public override void OnEffectEnd()
    {
        OverrideName(MiraLocaleManager.Get("TouRoleHunterStalk", "Stalk"));
    }
