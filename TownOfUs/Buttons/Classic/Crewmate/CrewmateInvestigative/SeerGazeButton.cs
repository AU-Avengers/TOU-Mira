...
{
    public override string Name => MiraLocaleManager.Get("TouRoleSeerGaze", "Gaze");
    ...
    protected override void OnClick()
    {
        ...
        {
            var text = MiraLocaleManager.Get("TouRoleSeerGazeNotif").Replace("<player>", Target.Data.PlayerName);
