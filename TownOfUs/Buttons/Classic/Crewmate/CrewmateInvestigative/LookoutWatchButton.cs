...
{
    public override string Name => MiraLocaleManager.Get("TouRoleLookoutWatch", "Watch");
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            $"<b>{MiraLocaleManager.Get(showRoles ? "TouRoleLookoutWatchNotif" : "TouRoleLookoutWatchAltNotif").Replace("<player>", Target.Data.PlayerName)}</b>",
