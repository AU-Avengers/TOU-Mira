...
{
    public override string Name => MiraLocaleManager.Get("TouRoleMorphlingSample", "Sample");
    ...
    protected override void OnClick()
    {
        ...
        var notif1 = Helpers.CreateAndShowNotification(
            MiraLocaleManager.Get("TouRoleMorphlingSampleNotif").Replace("<player>", $"{TownOfUsColors.ImpSoft.ToTextColor()}{Target.Data.PlayerName}</color>"),
            Color.white, new Vector3(0f, 1f, -20f), spr: TouRoleIcons.Morphling.LoadAsset());
        notif1.AdjustNotification();
