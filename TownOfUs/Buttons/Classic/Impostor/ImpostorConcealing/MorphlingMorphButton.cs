...
{
    public override string Name => MiraLocaleManager.Get("TouRoleMorphlingMorph", "Morph");
    ...
    public void AftermathHandler()
    {
        if (!EffectActive)
        {
            ...
            OverrideName(MiraLocaleManager.Get("TouRoleMorphlingUnmorph", "Unmorph"));
            UsesLeft--;
            if (LimitedUses)
            {
        ...
        else
        {
            ...
            OverrideName(MiraLocaleManager.Get("TouRoleMorphlingMorph", "Morph"));
        }
    }
