...
public class TouCrewRoleAchievementsTab : AchievementsTab
{
    ...
    public BaseBundleAchievement BloodyHands { get; set; } = new("Bloody Hands",
        "Find a suspect on the first Examine attempt.", TouCrewAssets.ExamineSprite, TouRoleIcons.Forensic);

    public BaseBundleAchievement RightOnTime { get; set; } = new("Right on Time",
        "Report a body quick enough to get the body's role / faction.", TouCrewAssets.InspectSprite, TouRoleIcons.Forensic);
    ...
    public BaseBundleAchievement TownOfHatred { get; set; } =
        new("Town of Hatred", "Find three unique pairs of enemies in a single game.", TouCrewAssets.IntuitSprite, TouRoleIcons.Seer);
    ...
    public BaseBundleAchievement Hyperfocused { get; set; } =
        new("Hyperfocused", "Keep track of more than 5 players at once.", TouCrewAssets.TrackSprite, TouRoleIcons.Sonar);
    ...
    public BaseBundleAchievement HuntingSeason { get; set; } =
        new("Hunting Season", "Successfully stalk and catch 3 players in a game.", TouCrewAssets.StalkButtonSprite, TouRoleIcons.Hunter);
    ...
    public BaseBundleAchievement Bloodshed { get; set; } =
        new("Bloodshed", "Kill more than 3 evils throughout a game.", TouCrewAssets.AlertSprite, TouRoleIcons.Veteran, 1);
    ...
    public BaseBundleAchievement TheDarkKnight { get; set; } =
        new("The Dark Knight", "Successfully guess 3 players throughout a round.", TouAssets.Guess, TouRoleIcons.Vigilante);
    ...
    public BaseBundleAchievement RiggedVotes { get; set; } =
        new("Rigged Votes", "Get knighted as a revealed Mayor.", TouCrewAssets.KnightSprite, TouRoleIcons.Politician, 1);
    ...
    public BaseBundleAchievement DeathByDemocracy { get; set; } =
        new("Death by Democracy", "Reveal in a 1v1.", TouAssets.RevealCleanSprite, TouRoleIcons.Mayor, 3, true);
