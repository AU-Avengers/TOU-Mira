...
public sealed class OracleRole : CrewmateRole, ITownOfUsRole, IWikiDiscoverable, IDoomable
{
    ...
    public void ReportOnConfession()
    {
        ...
        var confessing = ModifierUtils
            .GetPlayersWithModifier<OracleConfessModifier>((x) => x.Oracle == Player).FirstOrDefault();
