        ...
        if (TimeRemaining <= 0)
        {
            ...
            else if (Stage == HexBombStage.Countdown)
            {
                ...
                if (spellslinger != null)
                {
                    ...
                    {
                        DeathHandlerModifier.UpdateDeathHandlerImmediate(player, TouLocale.Get("DiedToSpellslingerHexBomb"), HudManagerHelper.Instance.CurrentRound, DeathHandlerOverride.SetTrue,
