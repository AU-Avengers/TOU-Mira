...
public sealed class AltruistOptions : AbstractOptionGroup<AltruistRole>
{
    ...
    public ModdedEnumOption KIllersAlertedAtStart { get; } =
        new("Killers Alerted Before Revive", (int)InformedKillers.Nobody, typeof(InformedKillers), ["Nobody", "Neutral Killers", "Impostors", "Neutrals and Impostors"]);

    public ModdedEnumOption KIllersAlertedAtEnd { get; } =
        new("Killers Alerted After Revive", (int)InformedKillers.NeutralsAndImpostors, typeof(InformedKillers), ["Nobody", "Neutral Killers", "Impostors", "Neutrals and Impostors"]);
