...
public sealed class EngineerOptions : AbstractOptionGroup<EngineerTouRole>
{
    ...
    public ModdedNumberOption MaxVents { get; } = new("TouOptionEngineerMaxVents", 0f, -1f, 30f, 1f, "0", "∞", MiraNumberSuffixes.None, "0");
    ...
    public ModdedNumberOption MaxFixes { get; } = new("TouOptionEngineerMaxFixes", 3f, -1f, 15f, 1f, "0", "∞", MiraNumberSuffixes.None, "0");
