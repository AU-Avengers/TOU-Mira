...
public sealed class AssailantModifierOptions : AbstractOptionGroup
{
    ...
    public AmountChanceOption ImpDoubleShotAmount { get; } = new("TouOptionDoubleShotAmount.Imp", 0, 0, 5, 1,
    ...
    public AmountChanceOption ImpDoubleShotChance { get; } = new("TouOptionDoubleShotChance.Imp", 50f, 0, 100f, 10f, "#",
        "#",
    ...
    public AmountChanceOption NeutDoubleShotAmount { get; } = new("TouOptionDoubleShotAmount.Neut", 0, 0, 5, 1,
    ...
    public AmountChanceOption NeutDoubleShotChance { get; } = new("TouOptionDoubleShotChance.Neut", 50f, 0, 100f, 10f, "#",
        "#",
    ...
    public AmountChanceOption ImpOverclockerAmount { get; } = new("TouOptionOverclockerAmount.Imp", 0, 0, 5, 1,
    ...
    public AmountChanceOption ImpOverclockerChance { get; } = new("TouOptionOverclockerChance.Imp", 50f, 0, 100f, 10f, "#",
        "#",
    ...
    public AmountChanceOption NeutOverclockerAmount { get; } = new("TouOptionOverclockerAmount.Neut", 0, 0, 5, 1,
    ...
    public AmountChanceOption NeutOverclockerChance { get; } = new("TouOptionOverclockerChance.Neut", 50f, 0, 100f, 10f, "#",
        "#",
