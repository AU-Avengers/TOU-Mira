        ...
        else
        {
            ...
            switch (roleAssignmentType)
            {
                ...
                case RoleDistribution.Draft:
                    ...
                    {
                        rolelistBuilder.AppendLine($"┣ {Palette.CrewmateBlue.ToTextColor()}Crew</color> Investigative: {draftCrewOpts.MaxCrewInvestigative.Value} Max");
                        rolelistBuilder.AppendLine($"┣ {Palette.CrewmateBlue.ToTextColor()}Crew</color> Killing: {draftCrewOpts.MaxCrewKilling.Value} Max");
                        rolelistBuilder.AppendLine($"┣ {Palette.CrewmateBlue.ToTextColor()}Crew</color> Power: {draftCrewOpts.MaxCrewPower.Value} Max");
                        rolelistBuilder.AppendLine($"┣ {Palette.CrewmateBlue.ToTextColor()}Crew</color> Protective: {draftCrewOpts.MaxCrewProtective.Value} Max");
                        rolelistBuilder.AppendLine($"┗ {Palette.CrewmateBlue.ToTextColor()}Crew</color> Support: {draftCrewOpts.MaxCrewSupport.Value} Max");
                        ...
                        rolelistBuilder.AppendLine($"┣ {TownOfUsColors.ImpSoft.ToTextColor()}Imp</color> Killing: {draftImpOpts.MaxImpKilling.Value} Max");
                        rolelistBuilder.AppendLine($"┣ {TownOfUsColors.ImpSoft.ToTextColor()}Imp</color> Power: {draftImpOpts.MaxImpPower.Value} Max");
                        rolelistBuilder.AppendLine($"┗ {TownOfUsColors.ImpSoft.ToTextColor()}Imp</color> Support: {draftImpOpts.MaxImpSupport.Value} Max");
                        ...
                        if (draftNeutOpts.MaxNeutrals.Value > 0)
                        {
                            ...
                            rolelistBuilder.AppendLine($"┣ {TownOfUsColors.Neutral.ToTextColor()}Neutral</color> Benign: {draftNeutOpts.MaxNeutBenign.Value} Max");
                            rolelistBuilder.AppendLine($"┣ {TownOfUsColors.Neutral.ToTextColor()}Neutral</color> Evil: {draftNeutOpts.MaxNeutEvil.Value} Max");
                            rolelistBuilder.AppendLine($"┣ {TownOfUsColors.Neutral.ToTextColor()}Neutral</color> Killing: {draftNeutOpts.MaxNeutKilling.Value} Max");
                            rolelistBuilder.AppendLine($"┗ {TownOfUsColors.Neutral.ToTextColor()}Neutral</color> Outlier: {draftNeutOpts.MaxNeutOutlier.Value} Max");
                        }
                        else
                        {
                            rolelistBuilder.AppendLine($"{TownOfUsColors.Neutral.ToTextColor()}Neutrals</color>: None");
                        }
                    }
                    break;
            }
