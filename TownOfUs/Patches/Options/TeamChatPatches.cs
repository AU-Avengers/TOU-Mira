...
public static class TeamChatPatches
{
    public static bool SplitChats =>
        LocalSettingsTabSingleton<TouLocalTabMisc>.Instance.SeparateChatBubbles.Value;
...
#pragma warning disable S2386
    ...
    {
        if (!LocalSettingsTabSingleton<TouLocalTabMisc>.Instance.SeparateChatBubbles.Value)
        {
