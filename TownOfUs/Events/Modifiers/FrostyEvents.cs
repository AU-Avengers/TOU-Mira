...
public static class FrostyEvents
{
    ...
    public static void AfterMurderEventHandler(AfterMurderEvent @event)
    {
        ...
        {
            var text = MiraLocaleManager.Get("TownOfUsMira.Modifier.FrostyTriggeredNotif").Replace("<player>", @event.Target.Data.PlayerName);
            text = text.Replace("<modifier>", $"{TownOfUsColors.Frosty.ToTextColor()}{MiraLocaleManager.Get("TownOfUsMira.Modifier.Frosty")}</color>");
