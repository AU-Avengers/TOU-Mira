...
public static class TelepathEvents
{
    ...
    public static void AfterMurderEventHandler(AfterMurderEvent @event)
    {
        ...
        if (PlayerControl.LocalPlayer.HasModifier<TelepathModifier>() && !source.AmOwner && !victim.AmOwner)
        {
            ...
            {
                AmongUsClient.Instance.StartCoroutine(MiscUtils.CoFlash(TownOfUsColors.ImpSoft, alpha: 0.4f));
            ...
            {
                AmongUsClient.Instance.StartCoroutine(MiscUtils.CoFlash(TownOfUsColors.ImpSoft, alpha: 0.05f));
                var notif1 = Helpers.CreateAndShowNotification(
