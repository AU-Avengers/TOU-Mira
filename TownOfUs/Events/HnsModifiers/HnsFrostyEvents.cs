...
public static class HnsFrostyEvents
{
    ...
    public static void AfterMurderEventHandler(AfterMurderEvent @event)
    {
        ...
        {
            var text = MiraLocaleManager.Get("HnsModifierFrostyTriggeredNotif").Replace("<player>", @event.Target.Data.PlayerName);
            text = text.Replace("<modifier>", $"{TownOfUsColors.Frosty.ToTextColor()}{MiraLocaleManager.Get("HnsModifierFrosty")}</color>");
