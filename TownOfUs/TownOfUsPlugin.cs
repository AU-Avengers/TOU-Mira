...
public partial class TownOfUsPlugin : BaseUnityPlugin, IMiraPlugin
{
    ...
    /// </summary>
    public static bool IsDevBuild => true /*IsBetaBuild || IsWipBuild*/;
    ...
    /// </summary>
    public static bool IsBetaBuild => false /*Version.Contains("beta", StringComparison.OrdinalIgnoreCase) || Version.Contains("prerelease", StringComparison.OrdinalIgnoreCase)*/;

    /// <summary>
    ///     Determines if the current build is a beta build. Beta builds are dev builds but should have restricted features like /up command.
    /// </summary>
    public static bool IsWipBuild => true /*Version.Contains("dev", StringComparison.OrdinalIgnoreCase) || Version.Contains("ci", StringComparison.OrdinalIgnoreCase)*/;
